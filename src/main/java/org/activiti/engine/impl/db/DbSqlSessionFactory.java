...
public class DbSqlSessionFactory implements SessionFactory {
  ...
  static {
    ...
    databaseSpecificLimitAfterStatements.put("gbase", "LIMIT ${maxResults} OFFSET ${firstResult}");
    ...
    addDatabaseSpecificStatement("gbase", "selectProcessDefinitionsByQueryCriteria", "selectProcessDefinitionsByQueryCriteria_mysql");
    addDatabaseSpecificStatement("gbase", "selectProcessDefinitionCountByQueryCriteria", "selectProcessDefinitionCountByQueryCriteria_mysql");
    addDatabaseSpecificStatement("gbase", "selectDeploymentsByQueryCriteria", "selectDeploymentsByQueryCriteria_gbase");
    addDatabaseSpecificStatement("gbase", "selectDeploymentCountByQueryCriteria", "selectDeploymentCountByQueryCriteria_mysql");
    addDatabaseSpecificStatement("gbase", "selectModelCountByQueryCriteria", "selectModelCountByQueryCriteria_gbase");
    addDatabaseSpecificStatement("gbase", "updateExecutionTenantIdForDeployment", "updateExecutionTenantIdForDeployment_mysql");
    addDatabaseSpecificStatement("gbase", "updateTaskTenantIdForDeployment", "updateTaskTenantIdForDeployment_mysql");
    addDatabaseSpecificStatement("gbase", "updateJobTenantIdForDeployment", "updateJobTenantIdForDeployment_mysql");
